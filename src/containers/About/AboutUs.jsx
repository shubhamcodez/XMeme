...
export default function AboutUs() {
    return (  
      ...
      <div>      
       ...
       <p>
           <h2>Memextream is a meme machine built Memelovers for Memelovers.</h2>
           <br/>
       </p>
       <p>
           <h2>Contribute to our mission with your skills:</h2>
           <a href="https://github.com/shubhamcodez/OPMeme"><h3 className='a-link'>Github</h3></a>
           <a href="https://www.paypal.com/paypalme/SSingh33?locale.x=en_GB"><h3 className='a-link'>Donate</h3></a>
        </p>
